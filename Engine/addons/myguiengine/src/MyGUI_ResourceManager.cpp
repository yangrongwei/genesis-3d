...
namespace MyGUI
{
	...
	void ResourceManager::reloadFontResource() const
	{
		MapResource::const_iterator itr = mResources.begin();

		for (; itr != mResources.end(); ++itr)
		{

			IFont* pFont = FontManager::getInstance().getByName(itr->first);
