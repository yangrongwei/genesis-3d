...
ALC_API void ALC_APIENTRY alc_init()
{
    int i;
    const char *devs, *str;
...
ALC_API void ALC_APIENTRY alc_deinit()
{
    int i;
...
ALC_API ALCdevice* ALC_APIENTRY alcOpenDevice(const ALCchar *deviceName)
{
    ...
    device->AuxiliaryEffectSlotMax = GetConfigValueInt(NULL, "slots", 100);
    if((ALint)device->AuxiliaryEffectSlotMax <= 0)
        device->AuxiliaryEffectSlotMax = 100;
