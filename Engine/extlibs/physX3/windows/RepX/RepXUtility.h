...
/**
	...
	\param inInstantiationOperator the operator over this instantiation result.
	\param inIdMap Id map to use.
...
struct RepXPxCollectionCoreItemAdder
{
	...
	void operator()( const TRepXId inId, PxAggregate* inActor ) {  addSceneObject( inId, inActor ); }
#if PX_USE_CLOTH_API
