...
public:
	...
	*/
    virtual void Print(const GPtr<IO::TextWriter>& textWriter, int depth ) const = 0;
...
public:
	...
	*/
    ...
    virtual void Print(const GPtr<IO::TextWriter>& textWriter, int depth) const;
...
public:
	...
	*/
    bool LoadStream(const GPtr<IO::Stream>& stream, TiXmlEncoding encoding = TIXML_DEFAULT_ENCODING );
	/// Save a file using the given FILE*. Returns true if successful.
    bool SaveStream(const GPtr<IO::Stream>& stream) const;
	...
	*/
    ...
    virtual void Print(const GPtr<IO::TextWriter>& textWriter, int depth = 0) const;
	// [internal use]
