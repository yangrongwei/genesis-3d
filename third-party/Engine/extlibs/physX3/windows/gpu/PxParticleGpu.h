...
public:
	...
	*/
	PX_PHYSX_CORE_API static bool createTriangleMeshMirror(const PxTriangleMesh& triangleMesh, pxtask::CudaContextManager& contextManager);
	...
	@see PxParticleBaseFlag.eGPU
	*/
	PX_PHYSX_CORE_API static void releaseTriangleMeshMirror(const PxTriangleMesh& triangleMesh, pxtask::CudaContextManager* contextManager = NULL);
	...
	@see PxParticleBaseFlag.eGPU
	*/
	PX_PHYSX_CORE_API static bool createHeightFieldMirror(const PxHeightField& heightField, pxtask::CudaContextManager& contextManager);
	...
	@see PxParticleBaseFlag.eGPU
	*/
	PX_PHYSX_CORE_API static void releaseHeightFieldMirror(const PxHeightField& heightField, pxtask::CudaContextManager* contextManager = NULL);
	...
	@see PxParticleBaseFlag.eGPU
	*/
	PX_PHYSX_CORE_API static bool createConvexMeshMirror(const PxConvexMesh& convexMesh, pxtask::CudaContextManager& contextManager);
	...
	@see PxParticleBaseFlag.eGPU
	*/
	PX_PHYSX_CORE_API static void releaseConvexMeshMirror(const PxConvexMesh& convexMesh, pxtask::CudaContextManager* contextManager = NULL);
