...
\note Typically actor and shape from the last query blocking hit result is used as a cached actor/shape pair.
...
//@{
	...
	*/
	...
	\return The rebuild rate of the dyamic tree pruning structures.
	...
	*/
	...
	\param[in] rebuilStaticStructure	True to rebuild the dynamic tree containing static objects
	...
	*/
	virtual void						forceDynamicTreeRebuild(bool rebuilStaticStructure, bool rebuildDynamicStructure)	= 0;
...
//@{
	...
	*/
	...
	@see setVisualizationParameter getVisualizationCullingBox
	*/
